    ...
    return (
        <section ref={containerRef} className='w-full mt-32 md:mt-36 xl:mt-40 relative'>
            <h1 className="text-[50px] leading-14 text-center text-white/90 md:text-left sm:text-[55px] md:text-[64px] xl:text-[84px] tracking-wide font-bold
                w-full">
                {renderLetters("frontend developer")}
            </h1>
            <div className="flex flex-col lg:flex-row items-center justify-start gap-6 xl:gap-16">
                <div className="w-[260px] h-[260px] sm:w-[305px] sm:h-[305px] rounded-full overflow-hidden mt-10 relative animate-slideRight">
                ...
                <div className="w-full max-w-96 md:max-w-[500px] lg:w-[58%] xl:w-1/2 mt-5 xl:mt-24 flex flex-col items-start gap-6 animate-slideLeft">
